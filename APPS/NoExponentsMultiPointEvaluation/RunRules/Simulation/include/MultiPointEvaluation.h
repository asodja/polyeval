 ...
 * \param [in] param_polynomialLength Interface Parameter "polynomialLength".
 * \param [in] instream_constants The stream should be of size (param_polynomialLength * 4) bytes.
...
void MultiPointEvaluation(
	...
	uint32_t param_polynomialLength,
...
typedef struct { 
	...
	uint32_t param_polynomialLength; /**<  [in] Interface Parameter "polynomialLength". */
	const float *instream_constants; /**<  [in] The stream should be of size (param_polynomialLength * 4) bytes. */
